<?php $__env->startSection('title', 'PM Bulk Upload'); ?>
...
<?php $__env->startSection('nav-links'); ?>
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('pm.dashboard')); ?>">
            <i class="bi bi-speedometer2"></i> Dashboard
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('pm.items.pending')); ?>">
            <i class="bi bi-clock-history"></i> Pending Items
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link active" href="<?php echo e(route('pm.bulk-upload')); ?>">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="d-flex align-items-center mb-4">
                <a href="<?php echo e(route('pm.dashboard')); ?>" class="btn btn-outline-secondary me-3">
            ...
            <div class="card shadow-sm">
                <div class="card-body p-4">
                    <form method="POST" action="<?php echo e(route('pm.store-bulk-upload')); ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-control-plaintext bg-light border rounded p-2">
                                ...
                                <strong><?php echo e($user->location->name); ?></strong> (<?php echo e($user->location->code); ?>)
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <input id="bulk_file" type="file" class="form-control <?php $__errorArgs = ['bulk_file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="<?php echo e(route('pm.dashboard')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\NEW_ONE-main\resources\views/pm/bulk-upload.blade.php ENDPATH**/ ?>