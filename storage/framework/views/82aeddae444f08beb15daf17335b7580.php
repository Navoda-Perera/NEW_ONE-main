<?php $__env->startSection('title', 'Receipt Generated'); ?>
    ...
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="<?php echo e(route('pm.single-item.index')); ?>" class="btn btn-pm-accent">
    ...
    <div class="col-12">
        <div class="alert alert-success d-flex align-items-center" role="alert">
            ...
            <div>
                ...
                <p class="mb-0">Receipt #<?php echo e(str_pad($receipt->id, 3, '0', STR_PAD_LEFT)); ?> has been generated with passcode <strong><?php echo e($receipt->passcode); ?></strong></p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card shadow-lg border-0">
            ...
            <div class="card-header bg-gradient text-white text-center py-4" style="background: linear-gradient(135deg, #28a745 0%, #20c997 100%);">
                <div class="d-flex align-items-center justify-content-center mb-2">
                    ...
                    <div>
                        ...
                        <small class="opacity-75">Receipt #<?php echo e(str_pad($receipt->id, 3, '0', STR_PAD_LEFT)); ?></small>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body p-4">
                    ...
                    <div class="col-md-6">
                        <div class="info-section">
                            ...
                            <div class="info-item mb-2">
                                <strong>Location:</strong> <?php echo e($receipt->location->name ?? 'N/A'); ?>

                            </div>
                            <div class="info-item mb-2">
                                <strong>PM:</strong> <?php echo e($receipt->itemBulk->creator->name ?? 'N/A'); ?>

                            </div>
                            <div class="info-item">
                                <strong>Date:</strong> <?php echo e($receipt->created_at->format('Y-m-d H:i:s')); ?>
                        ...
                        <div class="info-section">
                            ...
                            <div class="mb-3">
                                <span class="service-badge badge fs-6 px-3 py-2
                                    <?php echo e($receipt->itemBulk->service_type === 'slp_courier' ? 'bg-pm-primary' :
                                       ($receipt->itemBulk->service_type === 'cod' ? 'bg-warning text-dark' : 'bg-success')); ?>">
                                    <i class="bi bi-truck me-1"></i>
                                    <?php echo e(strtoupper(str_replace('_', ' ', $receipt->itemBulk->service_type))); ?>

                                </span>
                            </div>
                            <div class="passcode-display p-3 bg-light rounded">
                                <strong>Passcode:</strong>
                                <span class="badge bg-dark fs-6 ms-2"><?php echo e($receipt->passcode); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        ...
                        <?php $__currentLoopData = $receipt->itemBulk->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="row align-items-center">
                                    ...
                                    <div class="item-info">
                                        <div class="mb-3">
                                            ...
                                            <div class="barcode-display p-2 bg-white rounded border">
                                                <span class="font-monospace fw-bold fs-5"><?php echo e($item->barcode); ?></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="fw-bold"><?php echo e($item->weight); ?>g</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="recipient-info">
                                        ...
                                        <div class="mb-2">
                                            <strong>Name:</strong> <?php echo e($item->receiver_name); ?>

                                        </div>
                                        <div class="mb-2">
                                            <strong>Mobile:</strong> <?php echo e($item->smsSents->first()->receiver_mobile ?? 'N/A'); ?>

                                        </div>
                                        <div class="address-text">
                                            <strong>Address:</strong> <?php echo e($item->receiver_address); ?>
                    ...
                    <div class="col-md-8 mx-auto">
                        <div class="payment-summary p-4 bg-gradient rounded-3" style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%);">
                            ...
                            <div class="summary-details">
                                <?php if($receipt->itemBulk->service_type === 'cod'): ?>
                                    <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                                        <span class="text-muted">COD Amount:</span>
                                        <span class="fw-bold">LKR <?php echo e(number_format($receipt->amount, 2)); ?></span>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                                        <span class="text-muted">Postage Fee:</span>
                                        <span class="fw-bold">LKR <?php echo e(number_format($receipt->postage ?? 0, 2)); ?></span>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center py-3 bg-white rounded mt-3 px-3">
                                        ...
                                        <span class="fw-bold fs-4 text-success">LKR <?php echo e(number_format($receipt->total_amount ?? ($receipt->amount + ($receipt->postage ?? 0)), 2)); ?></span>
                                    </div>
                                <?php else: ?>
                                    <?php
                                    ...
                                    <div class="d-flex justify-content-between align-items-center py-3 bg-white rounded px-3">
                                        ...
                                        <span class="fw-bold fs-4 text-success">LKR <?php echo e(number_format($displayPostage, 2)); ?></span>
                                    </div>
                                <?php endif; ?>
                                ...
                                <div class="row mt-3 pt-3 border-top">
                                    <div class="col-6">
                                        ...
                                        <div class="fw-bold"><?php echo e($receipt->item_quantity); ?></div>
                                    </div>
                                    <div class="col-6 text-end">
                                        <span class="text-muted small">Payment Type:</span>
                                        <div>
                                            <span class="badge bg-pm-accent text-white"><?php echo e(strtoupper($receipt->payment_type)); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <ul class="terms-list mb-0 small text-muted">
                                        ...
                                        <?php endif; ?>
                                        <?php if($receipt->itemBulk->service_type === 'register_post'): ?>
                                        <li class="mb-2">
            ...
            <div class="card-footer bg-light text-center py-3">
                <div class="d-flex align-items-center justify-content-center text-muted">
                    ...
                    <small class="me-3">Generated on <?php echo e($receipt->created_at->format('Y-m-d H:i:s')); ?></small>
                    <span class="mx-2">|</span>
                    <i class="bi bi-hash me-1"></i>
                    <small class="me-3">Receipt ID: <?php echo e($receipt->id); ?></small>
                    <span class="mx-2">|</span>
...
<?php echo $__env->make('layouts.modern-pm', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\NEW_ONE-main\resources\views/pm/single-item/receipt.blade.php ENDPATH**/ ?>