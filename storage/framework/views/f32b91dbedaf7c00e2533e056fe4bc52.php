<?php $__env->startSection('title', 'Create Register Post Item'); ?>
        ...
        <div class="col-12">
            ...
            <div class="card border-0 rounded-top-0 shadow">
                <div class="card-body p-4">
                    <form method="POST" action="<?php echo e(route('pm.single-item.store-register')); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="sender_nic" name="sender_nic"
                                       value="<?php echo e(old('sender_nic')); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control" id="sender_address" name="sender_address"
                                          rows="2" required><?php echo e(old('sender_address')); ?></textarea>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.modern-pm', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\NEW_ONE-main\resources\views/pm/single-item/register-form.blade.php ENDPATH**/ ?>