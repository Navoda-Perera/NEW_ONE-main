<?php $__env->startSection('title', 'Create Postal Bag Dispatch'); ?>
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('pm.dispatch.store')); ?>" method="POST" id="dispatchForm">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <?php $__currentLoopData = $deliveryOffices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $office): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($office->id); ?>" 
                                                <?php echo e(old('destination_office') == $office->id ? 'selected' : ''); ?>>
...
<script>
    $(document).ready(function() {
        ...
        function addItemByBarcode() {
            ...
            const availableItem = <?php echo json_encode($availableItems->keyBy('barcode'), 15, 512) ?>;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.modern-pm', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\NEW_ONE-main\resources\views/pm/dispatch/create.blade.php ENDPATH**/ ?>