            ...
            <div class="d-flex align-items-center mb-4">
                ...
                <div>
                    ...
                    <p class="text-muted mb-0">
                        Add a new postman to <?php echo e(auth()->user()->location->name ?? 'your location'); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="temporary" <?php echo e(old('postman_type') === 'temporary' ? 'selected' : ''); ?>>
                                        Temporary
                                    </option>
                                    <option value="substitute" <?php echo e(old('postman_type') === 'substitute' ? 'selected' : ''); ?>>
                                        Substitute
                                    </option>
                                </select>
