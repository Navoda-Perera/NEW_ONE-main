...
<head>
    ...
    <title>Customer Login - Multi-Auth System</title>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card login-card border-0">
                    <div class="card-header customer-header text-center py-4">
                        <i class="bi bi-person-circle-fill fs-1 mb-3"></i>
                        <h3 class="mb-0">Customer Login</h3>
                        <p class="mb-0 opacity-75">External Client Portal</p>
                    </div>
                    <div class="card-body p-4">
                        ...
                        <form method="POST" action="<?php echo e(route('customer.login.post')); ?>" id="loginForm">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="text-center">
                            <div class="border-top pt-3">
                                <small class="text-muted">
                                    ...
                                    <a href="<?php echo e(route('customer.register')); ?>" class="text-decoration-none">Register here</a>
                                </small>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function refreshCSRFToken() {
            fetch('<?php echo e(route("csrf.refresh")); ?>', {
                method: 'GET',
                headers: {
...
<?php /**PATH C:\Users\User\Desktop\NEW_ONE-main\resources\views/customer/auth/login.blade.php ENDPATH**/ ?>