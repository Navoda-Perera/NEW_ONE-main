                ...
                <div class="col-md-10 col-lg-8">
                            ...
                            <div class="card h-100 shadow-sm border-0">
                                <div class="card-body text-center p-4">
                                    ...
                                    <div class="d-grid gap-2">
                                        <a href="<?php echo e(route('admin.login')); ?>" class="btn btn-primary btn-lg">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card h-100 shadow-sm border-0">
                                <div class="card-body text-center p-4">
                                    ...
                                    <div class="d-grid gap-2">
                                        <a href="<?php echo e(route('pm.login')); ?>" class="btn btn-warning btn-lg text-white">
                        ...
                        <div class="col-lg-4 col-md-6 mx-auto">
                            <div class="card h-100 shadow-sm border-0">
                                <div class="card-body text-center p-4">
                                    ...
                                    <div class="d-grid gap-2">
                                        <a href="<?php echo e(route('customer.login')); ?>" class="btn btn-success btn-lg">
                                            <i class="bi bi-box-arrow-in-right me-2"></i>Customer Login
                                        </a>
                                        <a href="<?php echo e(route('customer.register')); ?>" class="btn btn-outline-success">
                    ...
                    <div class="text-center mt-4">
                        <small class="text-muted">
                            Powered by Laravel <?php echo e(app()->version()); ?> |
...
<?php /**PATH C:\Users\User\Desktop\NEW_ONE-main\resources\views/welcome.blade.php ENDPATH**/ ?>