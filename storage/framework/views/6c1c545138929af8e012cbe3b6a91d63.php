...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            ...
            Add Items to Dispatch: <?php echo e($dispatch->manifest_id); ?>

        </h1>
        <div>
            <a href="<?php echo e(route('pm.dispatch.manifest', $dispatch->id)); ?>" class="btn btn-sm btn-info shadow-sm mr-2">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="h6 mb-0 text-gray-900"><?php echo e($dispatch->manifest_id); ?></div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                Neck Label
                            </div>
                            <div class="h6 mb-0 text-gray-900"><?php echo e($dispatch->necklabel); ?></div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                Destination Office
                            </div>
                            <div class="h6 mb-0 text-gray-900"><?php echo e($dispatch->destinationOffice->name); ?></div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                Items Added
                            ...
                            <div class="h6 mb-0 text-gray-900">
                                <span id="itemsCount"><?php echo e($dispatch->dispatchAssociates->count()); ?></span> items
                            </div>
                        </div>
                    </div>
                </div>
