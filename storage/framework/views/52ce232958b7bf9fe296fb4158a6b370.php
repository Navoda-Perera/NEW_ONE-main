<?php $__env->startSection('title', 'Lookup Dispatch by Barcode'); ?>
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="text-center mb-4">
                        ...
                        <h5>Find Dispatch Information</h5>
                    ...
                    <form method="POST" action="<?php echo e(route('pm.dispatch.search-by-barcode')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-info btn-lg">
                                <i class="fas fa-search"></i> Find Dispatch
                            </button>
                        </div>
                    </form>
                </div>
...
<?php echo $__env->make('layouts.modern-pm', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\NEW_ONE-main\resources\views/pm/dispatch/lookup-by-barcode.blade.php ENDPATH**/ ?>