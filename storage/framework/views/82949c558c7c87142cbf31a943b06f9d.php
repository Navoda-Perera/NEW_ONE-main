...
<div class="row">
    <div class="col-lg-8 col-xl-6">
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                <form method="POST" action="<?php echo e(route('pm.companies.store')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="type" name="type" required>
                                ...
                                <option value="credit" <?php echo e(old('type') === 'credit' ? 'selected' : ''); ?>>Credit</option>
                                <option value="franking" <?php echo e(old('type') === 'franking' ? 'selected' : ''); ?>>Franking</option>
                                <option value="prepaid" <?php echo e(old('type') === 'prepaid' ? 'selected' : ''); ?>>Prepaid</option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="assign_postoffice" name="assign_postoffice" required>
                                ...
                                <?php $__currentLoopData = $postoffices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $postoffice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($postoffice->id); ?>" <?php echo e(old('assign_postoffice') == $postoffice->id ? 'selected' : ''); ?>>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="<?php echo e(route('pm.companies.index')); ?>" class="btn btn-secondary">
