...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="<?php echo e(route('pm.dispatch.create')); ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                    ...
                                    <td>
                                        <div class="btn-group-vertical btn-group-sm" role="group">
                                            ...
                                            <button type="button"
                                                    ...
                                                    title="Delete"
                                                    data-toggle="modal"
                                                    data-target="#deleteModal<?php echo e($dispatch->id); ?>">
                                                <i class="fas fa-trash"></i> Delete
                                            </button>
                                        </div>

                                        <!-- Delete Modal -->
                                        <div class="modal fade" id="deleteModal<?php echo e($dispatch->id); ?>" tabindex="-1">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        Are you sure you want to delete dispatch <strong><?php echo e($dispatch->manifest_id); ?></strong>?
