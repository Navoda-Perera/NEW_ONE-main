...
<?php $__env->startSection('nav-links'); ?>
    <li class="nav-item">
        <a class="nav-link active" href="<?php echo e(route('customer.dashboard')); ?>">
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('customer.receipts.index')); ?>">
            <i class="bi bi-receipt"></i> My Receipts
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('customer.tracking.index')); ?>">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <?php if($user->location): ?>
                                <p class="mb-0 text-muted" style="font-weight: 500;">
                                    ...
                                    <strong>Post Office:</strong> <?php echo e($user->location->location_name); ?>
                        ...
                        <div class="col-md-4 text-md-end">
                            <div class="d-inline-flex align-items-center bg-primary bg-opacity-10 text-primary rounded-pill px-3 py-2" style="border: 1px solid rgba(13, 110, 253, 0.2);">
                                ...
                                <span class="fw-bold"><?php echo e(ucfirst(str_replace('_', ' ', $user->user_type))); ?> Account</span>
                            </div>
            ...
            <div class="card border-0 shadow-sm h-100" style="background: linear-gradient(135deg, #fff 0%, #f8f9fa 100%); border-left: 4px solid #0d6efd !important;">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h3 class="fw-bold mb-1 text-primary" style="font-family: 'Segoe UI', system-ui;"><?php echo e($totalItems); ?></h3>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="card border-0 shadow-sm h-100" style="background: linear-gradient(135deg, #fff 0%, #fff3cd 100%); border-left: 4px solid #ffc107 !important;">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h3 class="fw-bold mb-1 text-warning" style="font-family: 'Segoe UI', system-ui;"><?php echo e($pendingItems); ?></h3>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="card border-0 shadow-sm h-100" style="background: linear-gradient(135deg, #fff 0%, #d1e7dd 100%); border-left: 4px solid #198754 !important;">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h3 class="fw-bold mb-1 text-success" style="font-family: 'Segoe UI', system-ui;"><?php echo e($acceptedItems); ?></h3>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="card border-0 shadow-sm h-100" style="background: linear-gradient(135deg, #fff 0%, #f8d7da 100%); border-left: 4px solid #dc3545 !important;">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h3 class="fw-bold mb-1 text-danger" style="font-family: 'Segoe UI', system-ui;"><?php echo e($rejectedItems); ?></h3>
            ...
            <div class="card border-0 shadow-sm h-100" style="background: linear-gradient(135deg, #fff 0%, #f8f9fa 100%);">
                ...
                <div class="card-body p-4">
                    <div class="d-grid gap-3">
                        <a href="<?php echo e(route('customer.services.index')); ?>" class="btn btn-primary btn-lg shadow-sm" style="font-weight: 600; border-radius: 8px;">
                            <i class="bi bi-box-seam me-2"></i>
                            <span>Postal Services</span>
                        </a>
                        <a href="<?php echo e(route('customer.services.add-single-item')); ?>" class="btn btn-success btn-lg shadow-sm" style="font-weight: 600; border-radius: 8px;">
                            <i class="bi bi-plus-circle me-2"></i>
                            <span>Add Single Item</span>
                        </a>
                        <a href="<?php echo e(route('customer.services.bulk-upload')); ?>" class="btn btn-info btn-lg shadow-sm" style="font-weight: 600; border-radius: 8px;">
                            <i class="bi bi-cloud-upload me-2"></i>
                            <span>Bulk Upload</span>
                        </a>
                        <a href="<?php echo e(route('customer.receipts.index')); ?>" class="btn btn-warning btn-lg shadow-sm" style="font-weight: 600; border-radius: 8px;">
                            <i class="bi bi-receipt me-2"></i>
                            <span>My Receipts</span>
                        </a>
                        <a href="<?php echo e(route('customer.services.items')); ?>" class="btn btn-outline-secondary btn-lg shadow-sm" style="font-weight: 600; border-radius: 8px; border-width: 2px;">
            ...
            <div class="card border-0 shadow-sm h-100" style="background: linear-gradient(135deg, #fff 0%, #f8f9fa 100%);">
                ...
                <div class="card-body p-4">
                    <?php if(!empty($serviceBreakdown)): ?>
                        <div class="row g-3">
                            <?php $__currentLoopData = $serviceBreakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-12">
            ...
            <div class="card border-0 shadow-sm h-100" style="background: linear-gradient(135deg, #fff 0%, #f8f9fa 100%);">
                ...
                <div class="card-body p-4">
                    <?php if($recentUploads->count() > 0): ?>
                        <div class="timeline">
                            <?php $__currentLoopData = $recentUploads->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $upload): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div>
                                                    <h6 class="mb-0 fw-bold" style="font-family: 'Segoe UI', system-ui; font-weight: 600;">
                                                        <?php if($upload->associates->count() > 0): ?>
                                                            <?php echo e(ucfirst(str_replace('_', ' ', $upload->associates->first()->service_type))); ?>
                                                    ...
                                                    <small class="text-muted" style="font-weight: 500;">
                                                        <?php echo e($upload->associates->count()); ?> items • <?php echo e($upload->created_at->diffForHumans()); ?>

                                                    </small>
                                                </div>
                                                <span class="badge <?php echo e($upload->status === 'accept' ? 'bg-success' : ($upload->status === 'reject' ? 'bg-danger' : 'bg-warning')); ?>" style="font-weight: 500;">
                        ...
                        <div class="text-center mt-3">
                            <a href="<?php echo e(route('customer.services.items')); ?>" class="btn btn-outline-primary btn-sm" style="font-weight: 600; border-radius: 6px;">
                    ...
                    <div class="row g-4">
                        <div class="col-md-3">
                            <div class="text-center">
                                ...
                                <h6 class="fw-bold" style="font-family: 'Segoe UI', system-ui; font-weight: 600;"><?php echo e($user->name); ?></h6>
                                <small class="text-muted" style="font-weight: 500;"><?php echo e($user->email ?: 'No email provided'); ?></small>
                            </div>
                        </div>
                        <div class="col-md-9">
                            <div class="row g-4">
                                <div class="col-md-4">
                                    <div class="border-start border-primary border-3 ps-3" style="border-radius: 0 4px 4px 0; background: linear-gradient(135deg, rgba(13, 110, 253, 0.05) 0%, rgba(13, 110, 253, 0.02) 100%);">
                                        ...
                                        <p class="mb-0 fw-bold">
                                            <span class="badge bg-primary" style="font-weight: 600;"><?php echo e(ucfirst(str_replace('_', ' ', $user->user_type))); ?></span>
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="border-start border-primary border-3 ps-3" style="border-radius: 0 4px 4px 0; background: linear-gradient(135deg, rgba(13, 110, 253, 0.05) 0%, rgba(13, 110, 253, 0.02) 100%);">
                                        ...
                                        <p class="mb-0 fw-bold" style="font-family: 'Segoe UI', system-ui;"><?php echo e($user->created_at->format('M d, Y')); ?></p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="border-start border-primary border-3 ps-3" style="border-radius: 0 4px 4px 0; background: linear-gradient(135deg, rgba(13, 110, 253, 0.05) 0%, rgba(13, 110, 253, 0.02) 100%);">
                            ...
                            <div class="mt-4">
                                <a href="<?php echo e(route('customer.profile')); ?>" class="btn btn-primary" style="font-weight: 600; border-radius: 8px; padding: 10px 20px;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\NEW_ONE-main\resources\views/customer/dashboard.blade.php ENDPATH**/ ?>