...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Dashboard'); ?> - SL POST COURIER SYSTEM</title>
            ...
            <div class="dropdown">
                <a href="#" class="sidebar-user-info" data-bs-toggle="dropdown">
                    ...
                    <div class="sidebar-user-details">
                        <span class="sidebar-user-name"><?php echo e($currentUser->name); ?></span>
                        <span class="sidebar-user-role"><?php echo e(ucfirst($currentUser->role)); ?></span>
                    </div>
                </a>
...
</html><?php /**PATH C:\Users\User\Desktop\NEW_ONE-main\resources\views/layouts/modern-admin.blade.php ENDPATH**/ ?>