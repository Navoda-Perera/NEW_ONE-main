            ...
            <div class="col-md-6 col-lg-4">
                <div class="card login-card border-0">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="POST" action="<?php echo e(route('pm.login.post')); ?>" id="loginForm">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\User\Desktop\NEW_ONE-main\resources\views/pm/auth/login.blade.php ENDPATH**/ ?>