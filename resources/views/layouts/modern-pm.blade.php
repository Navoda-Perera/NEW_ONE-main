    ...
    <div class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-item dropdown-nav">
                ...
                <div class="collapse {{ request()->routeIs('pm.single-item.*') || request()->routeIs('pm.bulk-upload.*') || request()->routeIs('pm.customer-uploads*') ? 'show' : '' }}" id="uploadSubmenu">
                    <div class="submenu">
                        <a href="{{ route('pm.single-item.index') }}" class="submenu-link {{ request()->routeIs('pm.single-item.*') ? 'active' : '' }}">
                            <i class="bi bi-box-seam"></i>
                            <span>Add Single Item</span>
                        </a>
                        <a href="{{ route('pm.bulk-upload.index') }}" class="submenu-link {{ request()->routeIs('pm.bulk-upload.*') ? 'active' : '' }}">
                            <i class="bi bi-cloud-upload-fill"></i>
                            <span>Bulk Upload</span>
                        </a>
                        <a href="{{ route('pm.customer-uploads') }}" class="submenu-link {{ request()->routeIs('pm.customer-uploads*') ? 'active' : '' }}">
            ...
            <div class="nav-item dropdown-nav">
                <a href="#" class="nav-link dropdown-toggle {{ request()->routeIs('pm.dispatch.*') ? 'active' : '' }}" data-bs-toggle="collapse" data-bs-target="#dispatchSubmenu" aria-expanded="{{ request()->routeIs('pm.dispatch.*') ? 'true' : 'false' }}">
                    <i class="bi bi-truck"></i>
                    <span>Dispatch</span>
                    <i class="bi bi-chevron-down dropdown-arrow"></i>
                </a>
                <div class="collapse {{ request()->routeIs('pm.dispatch.*') ? 'show' : '' }}" id="dispatchSubmenu">
                    <div class="submenu">
                        <a href="{{ route('pm.dispatch.index') }}" class="submenu-link {{ request()->routeIs('pm.dispatch.index') || request()->routeIs('pm.dispatch.show') || request()->routeIs('pm.dispatch.create') || request()->routeIs('pm.dispatch.edit') ? 'active' : '' }}">
                            <i class="bi bi-mailbox"></i>
                            <span>Bag Dispatch</span>
                        </a>
                        <a href="{{ route('pm.dispatch.change-location') }}" class="submenu-link {{ request()->routeIs('pm.dispatch.change-location') ? 'active' : '' }}">
                            <i class="bi bi-arrow-left-right"></i>
                            <span>Change Dispatch Location</span>
                        </a>
                        <a href="{{ route('pm.dispatch.receive-by-necklabel') }}" class="submenu-link {{ request()->routeIs('pm.dispatch.receive-by-necklabel') || request()->routeIs('pm.dispatch.find-items-by-necklabel') ? 'active' : '' }}">
                            <i class="bi bi-inbox"></i>
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div>
                            <div class="user-name">{{ auth('pm')->user()->name }}</div>
