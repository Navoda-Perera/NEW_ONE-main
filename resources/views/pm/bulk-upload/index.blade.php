...
@section('title', 'Bulk Upload Management')
    ...
    <div class="col-lg-4 col-md-6">
        <div class="card border-0 shadow-sm h-100 service-card courier-card">
            <div class="card-body text-center p-4">
                ...
                <a href="{{ route('pm.bulk-upload.slp-form') }}" class="btn btn-primary btn-lg w-100 service-btn">
    ...
    <div class="col-lg-4 col-md-6">
        <div class="card border-0 shadow-sm h-100 service-card cod-card">
            <div class="card-body text-center p-4">
                ...
                <a href="{{ route('pm.bulk-upload.cod-form') }}" class="btn btn-warning btn-lg w-100 service-btn">
    ...
    <div class="col-lg-4 col-md-6">
        <div class="card border-0 shadow-sm h-100 service-card register-card">
            <div class="card-body text-center p-4">
                ...
                <a href="{{ route('pm.bulk-upload.register-form') }}" class="btn btn-danger btn-lg w-100 service-btn">
