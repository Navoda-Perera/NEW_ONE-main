                ...
                <form method="POST" action="{{ route('pm.customers.store') }}">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text"
                                   class="form-control form-control-lg @error('company_br') is-invalid @enderror"
                                   id="company_br"
                                   name="company_br"
                            ...
                            <div class="alert alert-info d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    @if(isset($locations) && $locations->count() > 0)
                                        <br><small class="text-muted">Location: {{ $locations->first()->name ?? 'Your Current Location' }}</small>
                                    @endif
                                </div>
                            </div>
                        </div>
