    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 col-xl-6">
            <div class="d-flex align-items-center mb-4">
                ...
                <div>
                    <h1 class="h2 mb-1">
                        <i class="bi bi-person-plus me-2"></i>Add New Postman
                    </h1>
                    <p class="text-muted mb-0">
                        Add a new postman to {{ auth()->user()->location->name ?? 'your location' }}
                    </p>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('pm.postmen.store') }}" method="POST" novalidate>
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('postman_type') is-invalid @enderror"
                                    ...
                                    <option value="permanent" {{ old('postman_type') === 'permanent' ? 'selected' : '' }}>
                                        Permanent
                                    </option>
                                    <option value="temporary" {{ old('postman_type') === 'temporary' ? 'selected' : '' }}>
                                        Temporary
                                    </option>
                                    <option value="substitute" {{ old('postman_type') === 'substitute' ? 'selected' : '' }}>
                                        Substitute
                                    </option>
                                </select>
                                @error('postman_type')
                        ...
                        <div class="alert alert-info mt-4">
                            ...
                            <strong>({{ auth()->user()->location->name ?? 'Unknown Location' }})</strong>
                            automatically.
                        </div>
                        ...
                        <div class="d-flex gap-2 justify-content-end mt-4">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-circle me-1"></i>Create Postman
                            </button>
                        </div>
                    </form>
                </div>
