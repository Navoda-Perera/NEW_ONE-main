...
echo "=== Testing Receipt Creation with Postage ===\n";
...
try {
    ...
    foreach ($pendingItems as $tempItem) {
        ...
        echo "Processed item: {$tempItem->barcode}\n";
    }

    // Create receipt - This is the key part we're testing
